...
public class TransformationDekorator extends ShapeDecorator{
    ...
    public TransformationDekorator(Shape shape,boolean translate, Vec2 translateVector, boolean rotate, double rotateAngle, Vec2 rotateCenter, boolean scale, Vec2 scaleVector) {
        super(shape);
    ...
    public static class Builder {
        ...
        public TransformationDekorator build (Shape shape)
        {
            return new TransformationDekorator(shape, translate, translateVector, rotate, rotateAngle, rotateCenter, scale, scaleVector);
        }
    }
